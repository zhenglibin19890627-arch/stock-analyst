...
class MockDataProvider:
    ...
    def _gen_normal(self, close: float) -> dict:
        ...
        return {
            ...
            # 020R-48 多周期字段
            'weekly_ma10': round(close * random.uniform(0.94, 1.06), 2),
            'weekly_ma20': round(close * random.uniform(0.92, 1.08), 2),
            'weekly_macd_dif': round(random.uniform(-0.4, 0.4), 4),
            'weekly_macd_dea': round(random.uniform(-0.3, 0.3), 4),
            'weekly_rsi14': round(random.uniform(30, 70), 2),
            'weekly_boll_position': round(random.uniform(10, 90), 2),
            'monthly_ma5': round(close * random.uniform(0.92, 1.08), 2),
            'monthly_ma10': round(close * random.uniform(0.90, 1.10), 2),
            'monthly_macd_dif': round(random.uniform(-0.4, 0.4), 4),
            'monthly_macd_dea': round(random.uniform(-0.3, 0.3), 4),
